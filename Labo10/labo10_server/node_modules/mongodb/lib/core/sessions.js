...
const uuidV4 = require('mongodb/lib/core/utils').uuidV4;
const MongoError = require('mongodb/lib/core/error').MongoError;
const isRetryableError = require('mongodb/lib/core/error').isRetryableError;
const MongoNetworkError = require('mongodb/lib/core/error').MongoNetworkError;
const MongoWriteConcernError = require('mongodb/lib/core/error').MongoWriteConcernError;
const Transaction = require('mongodb/lib/core/transactions').Transaction;
const TxnState = require('mongodb/lib/core/transactions').TxnState;
const isPromiseLike = require('mongodb/lib/core/utils').isPromiseLike;
const ReadPreference = require('mongodb/lib/core/topologies/read_preference');
const isTransactionCommand = require('mongodb/lib/core/transactions').isTransactionCommand;
const resolveClusterTime = require('mongodb/lib/core/topologies/shared').resolveClusterTime;
const isSharded = require('mongodb/lib/core/wireprotocol/shared').isSharded;
