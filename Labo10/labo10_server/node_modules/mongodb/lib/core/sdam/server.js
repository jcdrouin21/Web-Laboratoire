...
const ConnectionPool = require('mongodb/lib/cmap/connection_pool').ConnectionPool;
...
const ServerDescription = require('mongodb/lib/core/sdam/server_description').ServerDescription;
const ReadPreference = require('mongodb/lib/core/topologies/read_preference');
const Monitor = require('mongodb/lib/core/sdam/monitor').Monitor;
const MongoNetworkError = require('mongodb/lib/core/error').MongoNetworkError;
const collationNotSupported = require('mongodb/lib/core/utils').collationNotSupported;
const debugOptions = require('mongodb/lib/core/connection/utils').debugOptions;
const isSDAMUnrecoverableError = require('mongodb/lib/core/error').isSDAMUnrecoverableError;
const isNetworkTimeoutError = require('mongodb/lib/core/error').isNetworkTimeoutError;
const isNodeShuttingDownError = require('mongodb/lib/core/error').isNodeShuttingDownError;
const maxWireVersion = require('mongodb/lib/core/utils').maxWireVersion;
const makeStateMachine = require('mongodb/lib/core/utils').makeStateMachine;
const common = require('mongodb/lib/core/sdam/common');
