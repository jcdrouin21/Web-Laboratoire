...
const mongoErrorContextSymbol = require('mongodb/lib/core/error').mongoErrorContextSymbol;
...
const isUnifiedTopology = require('mongodb/lib/core/utils').isUnifiedTopology;
...
if (SUPPORTS.ASYNC_ITERATOR) {
  CoreCursor.prototype[Symbol.asyncIterator] = require('mongodb/lib/async/async_iterator').asyncIterator;
}
